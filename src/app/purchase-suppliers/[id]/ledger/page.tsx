...
export default async function PurchaseSupplierLedgerPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const ledger = await getPartyLedger(id, 'SUPPLIER')
    ...
    <div className="animate-fade-in">
      ...
      <header className="page-header" style={{ marginBottom: '2rem' }}>
        <div>
          ...
          <p className="page-subtitle">Detailed diamond stock history from this supplier</p>
        </div>
      </header>
