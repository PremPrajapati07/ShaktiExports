...
export default async function InvoiceViewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="invoice-view animate-fade-in">
      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: '2rem', flexWrap: 'wrap-reverse', alignItems: 'start' }}>
        <div className="invoice-preview glass-card" style={{ flex: '1 1 600px', margin: 0 }}>
        ...
        <div style={{ flex: '0 0 340px', minWidth: '300px' }}>
          <PDFActions invoice={invoice} profile={profile} isPurchase={false} />
        </div>
      </div>
    </div>
  )
